...
main_buttons = [[
    InlineKeyboardButton('❣️ ᴅᴇᴠᴇʟᴏᴘᴇʀ ❣️', url='https://t.me/staystrongbros')
],[
    ...
    InlineKeyboardButton('💝 sᴜʙsᴄʀɪʙᴇ ᴍʏ ʏᴏᴜᴛᴜʙᴇ ᴄʜᴀɴɴᴇʟ', url='https://youtube.com/@warrior')
],[
...
async def start(client, message):
    ...
    if not is_premium(user.id):
        return await message.reply("🚫 You are not a premium user. Contact admin to get access.")
